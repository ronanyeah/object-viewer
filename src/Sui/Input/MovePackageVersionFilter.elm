module Sui.Input.MovePackageVersionFilter exposing
    ( MovePackageVersionFilter, input, decoder
    , null
...
afterVersion : Sui.Uint53 -> MovePackageVersionFilter -> MovePackageVersionFilter
...
beforeVersion : Sui.Uint53 -> MovePackageVersionFilter -> MovePackageVersionFilter
