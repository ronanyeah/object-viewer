module Sui.Input.MovePackageCheckpointFilter exposing
    ( MovePackageCheckpointFilter, input, decoder
    , null
...
afterCheckpoint : Sui.Uint53 -> MovePackageCheckpointFilter -> MovePackageCheckpointFilter
...
beforeCheckpoint : Sui.Uint53 -> MovePackageCheckpointFilter -> MovePackageCheckpointFilter
